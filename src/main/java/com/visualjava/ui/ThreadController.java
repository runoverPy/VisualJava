...
public class ThreadController {
    ...
    public class ThreadEventsVisualizer implements ThreadEventsListener {
        ...
        public FrameEventsListener makeFrameListener(VMFrame frame) {
            FrameUIElement frameElement = new FrameUIElement(frame);
            frameElements.put(frame, frameElement);
            return frameElement.new FrameEventsVisualizer();
        }
        ...
        public void onInstrExec(ExecutionContext context) {
            Platform.runLater(() -> {
                cycleNumber.setText(String.valueOf(cycleCount));
                cycleCount++;
            });
        }
    }
